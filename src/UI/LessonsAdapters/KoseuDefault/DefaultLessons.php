...
?>
     ...
     **/
    public function __construct($relativeContext = 'KoseuDefault', $anchor = null, $index = null)
    {
        global $CFG;
            ...
            <div class="tab-pane fade active in" id="home">
                ...
                foreach ($this->lessons->badges ?? [] as $badge) {
                    ...
                    foreach ($badge->assignments as $resource_link_id) {
                        ...
                        echo ($lti->title ?? 'LTI Resource Not Found: ' . $resource_link_id . "</a>\n");
